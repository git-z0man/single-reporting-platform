...
| [`enisa-defect-report.md`](enisa-defect-report.md) | Errors, contradictions and gaps found in ENISA's own SRP pages, written to be handed to ENISA | 37 findings, tracked: within a day ENISA fixed 12, partly addressed 4, 21 open (re-checked 10 September 2026) |
