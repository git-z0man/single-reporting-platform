...
**Status re-checked**: **10 September 2026, 07:13 UTC**, against a fresh fetch
of every page. ENISA edited the pages eight more times in between; each
...
| **open** | still present on 10 September 2026, 07:13 UTC |
...
| [Guidance — AR Notification submission and update](https://www.enisa.europa.eu/topics/product-security/single-reporting-platform-srp/cra-srp-guidance-ar-notification-submission-and-update) | Submission | Last updated: 03 September 2026 (was 3/08/2026) |
...
| [List of CSIRTs Designated as Coordinators](https://www.enisa.europa.eu/topics/product-security/single-reporting-platform-srp/list-of-csirts-designated-as-coordinators) | CSIRT list | Last updated: 04 September 2026 (was "Updated: 04/09/2026") |
...
**Status: open** — no Glossary entry on 10 September.
...
**Status: open** — no Glossary or FAQ entry on 10 September.
...
**Status: open** — the limit appears in neither the Glossary nor the PEC page on 10 September.
...
**Status: open** — the Submission page was rewritten on 9 September 22:12 UTC with added screenshots, but the 72-hour and Final Report sections still each show one image, of the Dashboard step.
...
**Status: open** — main page unchanged on 10 September.
...
**Status: open** — the Content list still has six entries on 10 September.
...
**Status: open** — re-checked 10 September 2026, 07:13 UTC: HTTP 403, no `Location` header.
...
Of the 37 findings, **12 are fixed, 4 partly addressed, 21 open** as of
10 September 2026, 07:13 UTC.
...
| F6 | Main / Registration | "User guidance" card vs the page | Card blurb: "the Assigned **Representatives** (AR) user registration"; the page itself now: "the Assigned **Representative** (AR)…". The card also still says "Updated: 3/08/2026" for a page stamped 09 September. | 2026-09-10 00:10 |
