...
note: One logical block per FAQ entry to keep diffs readable. Update `retrieved` and content when a change is confirmed. As of 2026-08-17 the FAQ moved to its own subpage (faq_url above); the main SRP URL is now a landing/hub page — both must be checked.
last_check: 2026-08-17
last_change: 2026-08-17
---

# ENISA Single Reporting Platform (SRP) — FAQ Baseline

## Change log (2026-08-17 check, vs. 2026-08-03 baseline)

Major page restructuring since the last check. Summary: no FAQ questions added or deleted (still Q1–Q23), but the FAQ moved off the main URL onto its own subpage, nearly every FAQ answer was lightly copy-edited, one new guidance document appeared, and a new helpdesk contact section was added.

- **FAQ split onto a dedicated subpage.** The 23 questions are no longer on the main SRP page; they now live at faq_url (above), reached from the main page via a "View all FAQs" button. The FAQ subpage carries its own page-level note "Updated: 03 August 2026" (no more per-question "[Updated]" tags). Still Q1–Q23, no questions added or removed, Q16 data-field table values unchanged. Nearly every question was lightly copy-edited (inline hyperlinks added to referenced EC documents/Delegated Regulation, minor phrasing tweaks — e.g. Q1's "will serve as a 'single entry point,' allowing manufacturers to report ... only once" became "will serve as a 'single entry point', allowing for manufacturers to report ... having an impact on the security of products with digital elements only once"). No material change in meaning for any answer; full updated wording captured below.
- **Main page rewritten as a landing/hub page.** Intro paragraph reworded and split into a short teaser sentence plus four shorter paragraphs (same substance: SRP purpose, CRA mandate, 11 September 2026 date, transparency framing). The standalone closing line "Further information: Regulation (EU) 2024/2847 (EUR-Lex)" is gone as separate text — the CRA regulation is now linked inline from the first paragraph instead.
- **New "Need Help?" section** — helpdesk contact added: cra-srp-helpdesk[at]enisa.europa.eu (published in obfuscated `[@]` form on the live page).
- **Guidance documents: one new document added, two re-dated:**
  - "CRA SRP - AR User registration" — now Updated: 3/08/2026 (was 31/07/2026)
  - "CRA SRP - AR Notification submission and update" — now Updated: 3/08/2026 (was 31/07/2026)
  - **New:** "CRA SRP guidance - AR Interface functions" — Updated: 14/08/2026. "This page explains the AR's interface of the SRP for various functions that can be performed." Not previously listed.
- Factsheet section (first seen 2026-08-03) verified present and unchanged, same download link (https://www.enisa.europa.eu/sites/default/files/2026-07/ENISA_CRA_SRP_Factsheet_v1.0_0.pdf).
...
**CRA Single Reporting Platform Factsheet** — ENISA has published a factsheet on the CRA Single Reporting Platform. It can be downloaded here, currently in English. (https://www.enisa.europa.eu/sites/default/files/2026-07/ENISA_CRA_SRP_Factsheet_v1.0_0.pdf)

**Frequently asked questions** — "Find answers to common questions purpose of the SRP, reporting obligations, processes, timelines, users, and technical operation" — links to the FAQ subpage (faq_url above).
...
- **CRA SRP - AR User registration** — "This page provides information on the Assigned Representatives (AR) user registration in the SRP. It is intended for AR users (Primary and Secondary)." Updated: 3/08/2026
- **CRA SRP - AR Notification submission and update** — "This page provides information on the Assigned Representatives (AR) submission and update of notifications in the SRP. It is intended for AR users (Primary and Secondary)." Updated: 3/08/2026
- **CRA SRP guidance - AR Interface functions** [New, first seen 2026-08-17] — "This page explains the AR's interface of the SRP for various functions that can be performed." Updated: 14/08/2026

### Need Help? [New, first seen 2026-08-17]

For support, please contact: cra-srp-helpdesk[at]enisa.europa.eu
...
## FAQ entries (from faq_url, page-level note: "Updated: 03 August 2026")
...
Linked from the main SRP page under "User guidance" (referenced from FAQ Q9, Q10, Q17):

- "CRA SRP - AR User registration" — Updated: 3/08/2026
- "CRA SRP - AR Notification submission and update" — Updated: 3/08/2026
- "CRA SRP guidance - AR Interface functions" — Updated: 14/08/2026 [New 2026-08-17]
...
- 2026-08-17: checked (fetched raw HTML of both the main SRP page and the newly discovered FAQ subpage). Major restructuring found: FAQ moved to its own subpage (faq_url), main page rewritten as a landing/hub page with reworded intro, new "Need Help?" helpdesk-contact section, and a third guidance document ("CRA SRP guidance - AR Interface functions", Updated 14/08/2026) added alongside the existing two (both re-dated to 3/08/2026). Still Q1–Q23 with unchanged Q16 data-field table values, but nearly every FAQ answer was lightly copy-edited (inline hyperlinks added, minor phrasing) with no material change in meaning. File fully updated accordingly.
