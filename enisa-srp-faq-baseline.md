...
retrieved: 2026-09-15 (fetched 06:11 UTC, AR Interface Functions changed since 19:10 UTC on 2026-09-14 — see change log)
guidance_retrieved: 2026-09-15 (fetched 06:11 UTC, AR Interface Functions changed since 19:10 UTC on 2026-09-14; AR User Registration, AR Notification Submission and Update, and PEC unchanged)
glossary_retrieved: 2026-09-15 (fetched 06:11 UTC, unchanged since 23:15 UTC on 2026-09-13 — see `enisa-srp-glossary-baseline.md`)
csirt_list_retrieved: 2026-09-15 (fetched 06:11 UTC, unchanged since 17:11 UTC on 2026-09-12)
ar_user_manual_retrieved: 2026-09-15 (fetched 06:11 UTC, wording unchanged since first capture at 10:12 UTC on 2026-09-10)
terms_conditions_retrieved: 2026-09-15 (fetched 06:11 UTC, unchanged since the trailing space was lost at 14:07 UTC on 2026-09-10)
ar_user_tutorial_video_retrieved: 2026-09-15 (fetched 06:11 UTC, unchanged since first capture at 11:10 UTC on 2026-09-11)
...
**General Notes** *(prose turned into a 4-item bulleted list with bold lead-ins 2026-09-14 05:17 UTC; wording unchanged, reproduced below as the live page now structures it)*:
- AR users authenticate through EU Login when registering on the SRP. Authentication steps carried out within EU Login are not described here. Further information on EU Login is available through the official EU Login guidance at: https://trusted-digital-identity.europa.eu/index_en.
...
The notification is listed on the Dashboard. Exceptions: If you omit mandatory data, the SRP will return an error informing you of the missing data that must be provided. *(outer quotation marks gone, 2026-09-14 09:14 UTC; no wording change.)*
...
The notification is listed on the Dashboard and is subject to be validated by the CSIRT. Exception: If you omit mandatory data, the SRP will return an error informing you of the missing data that must be provided. *(outer quotation marks gone, 2026-09-14 09:14 UTC; no wording change; still singular "Exception:", unlike the Early Warning and Final Report Exceptions labels either side of it, which are plural.)*

*Submit a Final Report* — Pre-conditions: your user status is “Active”, you are logged in into the SRP and you have opened the Dashboard; an Early Warning and a 72-hour Notification have already been submitted. *(**2026-09-14 09:14 UTC**: this is now a genuine 2-item `<li>` bulleted list on the live page, same pattern and same two conditions as the 72-hour Notification precondition above, just unsplit here as before; straight quotes around "Active" also now curly.)* Steps:
- Click on an existing notification on the Dashboard.
...
- Click on the Settings menu. You can now view personal details or update manufacturer details by following the same steps used during the registration flow (separate "Personal details"/"Manufacturer details" screenshots).
...
Pop-up confirming the invitation has been sent is then displayed. *(dropped its leading "A" 2026-09-14 04:13 UTC — was "A pop-up confirming...")* Expected result: The SRP sends an email invitation to the Secondary AR. A new user record is created in the SRP with the specified email address and corresponding manufacturer details. The user role is assigned once the registration is completed. *(this precondition/expected-result sentence lost its own bold wrapping too, since 2026-09-14; wording unchanged — still correctly says the invitation goes to the Secondary AR, and the "Pending Invitation" status name is still not mentioned. Outer quotation marks around it also gone, 2026-09-14 09:14 UTC.)*
...
**Delete AR – Manufacturer Association**
Purpose: Follow these steps to manage the association between AR users and manufacturers, including removal of your own association or, where applicable, the association of a Secondary AR. Preconditions:
...
Steps:
- Open the AR Association Management page in the SRP. As a Primary AR, you can remove your own association or remove a Secondary AR for the manufacturer. As a Secondary AR, you can remove your own association. *(previously one parenthetical inside the "open the page" step; now two separate sentences — same substance.)*
