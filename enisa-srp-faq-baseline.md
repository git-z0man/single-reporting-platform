...
retrieved: 2026-09-14 (fetched 09:14 UTC, unchanged since 05:17 UTC — see change log)
guidance_retrieved: 2026-09-14 (fetched 09:14 UTC — a quote-style pass (outer quotation marks dropped from Exceptions/Expected-result sentences, most straight UI/status quotes turned curly) hit all four guidance pages; AR Interface Functions also lost the "(the "Action Required" tab is still not named by that label)" parenthetical; two new mismatched-quote defects and a doubled-style "Unverified" appeared; see change log)
glossary_retrieved: 2026-09-14 (fetched 09:14 UTC, unchanged since 23:15 UTC on 2026-09-13 — see `enisa-srp-glossary-baseline.md`)
csirt_list_retrieved: 2026-09-14 (fetched 09:14 UTC, unchanged since 17:11 UTC on 2026-09-12)
ar_user_manual_retrieved: 2026-09-14 (fetched 09:14 UTC, wording unchanged since first capture at 10:12 UTC on 2026-09-10)
terms_conditions_retrieved: 2026-09-14 (fetched 09:14 UTC, unchanged since the trailing space was lost at 14:07 UTC on 2026-09-10)
ar_user_tutorial_video_retrieved: 2026-09-14 (fetched 09:14 UTC, unchanged since first capture at 11:10 UTC on 2026-09-11)
...
- Submit the Final Report or save it as a draft.
...
Steps:
- Open a notification and update the necessary fields under the Notification tab.
- Click ‘Update’ to save the updated notification information. *(this bullet's straight double quotes around "Update" are now curly single quotes, 2026-09-14 09:14 UTC — the opposite style from the Exceptions sentence below, which stays curly double; no wording change.)*

Exceptions: If you omit mandatory data and click “Update”, the SRP will return an error informing you of the missing data that must be provided. *(curly double quotes around "Update" since 2026-09-14 05:17 UTC, was straight single quotes, click 'Update'; the outer quotation marks around this whole sentence are also gone as of 2026-09-14 09:14 UTC, no wording change.)* The SRP automatically notifies the CDaC via an alert and an email, and automatically notifies ENISA and any concerned CSIRTs that previously received the notification through dissemination, via an alert and an email.
