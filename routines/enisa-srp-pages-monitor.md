...
> **Applied 2026-09-07**, then amended 2026-09-08 — section 2 and the report
> line below have changed since that paste and are **not yet live**.
...
> the live Routine still carries the 2026-09-07 text, which describes the
...
The Glossary page has already moved once: on 2026-09-08 the URL that had been tracked began returning **HTTP 403**, and the page turned out to have been republished at `.../cra-srp-glossary2` with byte-identical content. A 403 on this page is therefore an ambiguous signal, not a diagnosis. Rules:
